...
const Sidebar = ({sidebar , category, setCategory}) => {
  return (
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>            {/*to short and expand the menu */}
        ...
        <div className="subscribed-list">
            ...
            <div className="side-links">
                <img src={jack} alt="" /><p>JK Tamil</p>
            </div>
            <div className="side-links">
                <img src={simon} alt="" /><p>Jay Kay</p>
            </div>
            <div className="side-links">
                <img src={tom} alt="" /><p>Reshiu Pedia</p>
            </div>
            <div className="side-links">
                <img src={megan} alt="" /><p>Homie5</p>
            </div>
            <div className="side-links">
                <img src={cameron} alt="" /><p>Saravanan Decodes</p>
            </div>
